...
export default function Home() {
  return (
    <main className='h-full'>
      ...
      <SplitSection reverse={false} mobile={false} left={<ImageBlock url="/images/trend-discover.png" title="live events" />} right={<ContentBlock isBlue={false} subtitle="The Solution" title={<>One Place to Plan, <br /> Set Vibes, and <span className='text-[#dcff00]'>Link Up</span></>} content="BLU creates one place to discover, coordinate, and communicate — built around sharing content & shared interests so linking up feels natural." />} />

      <section className="bg-[#2d72ff] bg-[url(/images/blu-text-pattern.svg)] bg-cover">
        <SplitSection reverse={true} mobile={false} left={<ImageBlock url="/images/community.png" title="community" />} right={<ContentBlock isBlue={true} subtitle="The Culture" title={<>Community is Everything</>} content="BLU is built around shared interests and proximity — not just followers, likes, or content sharing" />} />
      </section>
