  ...
  return (
    <section className="max-w-[1600px] mx-auto mb-10 p-4 relative">
      ...
      <div className="hero flex flex-col justify-center items-center gap-1 min-h-[450px] md:min-h-[500px] relative text-center">
        ...
        <h2 className="font-medium text-xl md:text-3xl tracking-[.1rem] md:tracking-[.2rem] uppercase">
          Built Different
        </h2>
        ...
        <p className="font-extralight text-lg md:text-2xl">
          The difference is we are mixing two worlds together. <br />
          B.L.U is built to surface meaningful local experiences using content.
        </p>
      </div>
      <div className="mx-auto overflow-x-auto">
        <table className="table-fixed min-w-[720px] w-full">
          <thead>
            <tr>
              <th></th>
              <th className="bg-[#dcff00] pt-2 text-black text-center text-xl">
                &nbsp;
              </th>
            ...
            <tr className="bg-[#181a1c]">
              ...
              <th className="bg-[#dcff00] m-0 text-black text-center text-xl align-top">
                <Image
                  src="/images/blu-icon_blk.svg"
                  width={30}
                  height={30}
                  alt="BLU icon"
              ...
              <th className="bg-[#2d72ff] p-4 text-center text-xl">
                <LiaMeetup size={40} className="inline-block mr-2" />
                Meetup
              </th>
              <th className="bg-[#2d72ff] p-4 text-center text-xl">
                <CgEventbrite size={30} className="inline-block mr-2" />{" "}
                Eventbrite
              </th>
            </tr>
          </thead>
          <tbody className="bg-black/60">
            <tr>
              ...
              <td className="td-center bg-[#dcff00] p-4 text-center">
                <IoCheckmarkSharp
                  color="black"
                  size={35}
