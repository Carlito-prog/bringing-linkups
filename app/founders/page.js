    ...
    <section className="flex flex-col justify-center items-center gap-20 max-w-[1600px] h-full md:h-screen mx-auto p-4 mb-5 md:mb-10">
      ...
      <div className="hero flex flex-col justify-center items-center gap-1 h-[400px] md:h-[650px]">
        ...
        <p className="font-extralight text-lg md:text-2xl">
          Built by people who believe connection should feel natural — Through
          shared interest. <br />
          We don’t just host events; we design spaces where community actually
          socializes.
        </p>
      </div>

      <motion.div
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 h-full w-full"
        initial="hidden"
