  ...
  return(
    <>
      <header className="hero bg-[url(/images/map-lines.svg)] bg-no-repeat bg-cover flex flex-col justify-center items-center gap-1 min-h-[500px] md:min-h-[650px] relative text-center">
        ...
        <p className="font-extralight text-lg md:text-2xl">BLU is designed to support real connection by prioritizing <span className='font-semibold'>people</span> and <span className='font-semibold'>interest</span>.</p>
      </header>
      <div>
